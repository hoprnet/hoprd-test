...
describe('GET /node/info', () => {
    ...
    it('should get info', async () => {
        node.network = { id: 'anvil-localhost' };
        ...
        expect(res.body).to.deep.equal({
            ...
            announcedAddress: DHT_ADDRESSES.map((addr) => addr.toString()),
            listeningAddress: LISTENING_ADDRS.map((addr) => addr.toString()),
            chain: 'a',
...
//# sourceMappingURL=info.integration.spec.js.map