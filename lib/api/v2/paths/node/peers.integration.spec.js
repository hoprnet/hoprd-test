...
import { createTestApiInstance, ALICE_PEER_ID, ALICE_MULTI_ADDR, BOB_PEER_ID, BOB_MULTI_ADDR, CHARLIE_PEER_ID } from '../../fixtures.js';
import { STATUS_CODES } from '../../utils.js';
import { PeerOrigin, PeerStatus, PEER_METADATA_PROTOCOL_VERSION } from '@hoprnet/hopr-core';
const meta = new Map([[PEER_METADATA_PROTOCOL_VERSION, '1.2.3']]);
const ALICE_ENTRY = PeerStatus.build(ALICE_PEER_ID.toString(), PeerOrigin.Initialization, false, BigInt(1646410980793), 1.0, BigInt(10), BigInt(10), 0, meta);
const BOB_ENTRY = PeerStatus.build(BOB_PEER_ID.toString(), PeerOrigin.Initialization, false, BigInt(1646410680793), 0.2, BigInt(0), BigInt(0), 0, meta);
const CHARLIE_ENTRY = PeerStatus.build(CHARLIE_PEER_ID.toString(), PeerOrigin.Initialization, false, BigInt(1646410980993), 0.8, BigInt(10), BigInt(8), 0, meta);
function toJsonDict(peer, isNew, multiaddr) {
...
//# sourceMappingURL=peers.integration.spec.js.map