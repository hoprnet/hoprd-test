 ...
 */
export const authenticateWsConnection = (req, apiToken) => {
    // throw if apiToken is empty
    if (apiToken === '')
        throw Error('Cannot authenticate empty apiToken');
 ...
 * @example `/api/v2/messages/websocket/?apiToken=^^LOCAL-testing-123^^` becomes `/api/v2/messages/websocket`
 */
export const removeQueryParams = (path) => {
...
export const getStatusCodeForInvalidInputInRequest = (inputPath) => {
