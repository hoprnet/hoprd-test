import { getIdentity, IdentityErrors } from './identity.js';
...
describe('Identity', function () {
    ...
    const mockIdentityOptions = {
        initialize: false,
        idPath: DUMMY_PATH,
        password: DUMMY_PASSWORD
    };
    const initializedMockIdentity = { ...mockIdentityOptions, initialize: true };
    const createInitializedMockIdentityWithPassword = (password) => ({
